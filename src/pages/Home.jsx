    ...
    <div>
      ...
      <div className='flex flex-col mt-8 w-full mb-8'>
        ...
        <div className='flex flex-col md:flex-row justify-center w-full mb-4'>
          ...
          <div className='bg-violet-700 w-full p-4 flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              <span><FaCheckCircle className='text-5xl text-gray-100' /></span>
              <span className=' text-2xl text-gray-200 font-bold'>Safety</span>
            </span>
            <span>
              <p className='text-gray-200 '>Safety is paramount, especially when it comes to household cleaning products. We offer a good cleaning products that are safe to use around people, pets, and the environment. It has a clear usage instructions and precautions to avoid any potential hazards.</p>
            </span>
          </div>
          ...
          <div className='bg-violet-700 w-full p-4  flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              ...
              <span className=' text-2xl text-gray-200 font-bold'>Versatility</span>
            </span>
            <span>
          ...
          <div className='bg-violet-700 w-full p-4  flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              ...
              <span className=' text-2xl text-gray-200 font-bold'>Effectiveness</span>
            </span>
            <span>
        ...
        <div className='flex flex-col md:flex-row w-full'>
          <div className='bg-violet-700 w-full p-4  flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              ...
              <span className=' text-2xl text-gray-200 font-bold'>Ease Of Use</span>
            </span>
            <span>
              <p className='text-gray-200 '>Our cleaning products are designed with user-friendliness in mind, ensuring that whether they come in spray, liquid, powder, or wipe form, the cleaning process demand minimal effort from the user. It is straightforward to use and is efficient in achieving cleaning goals.</p>
            </span>
          </div>
          <div className='bg-violet-700 w-full p-4  flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              <span><GiFragrance className='text-5xl text-gray-100' /></span>
              <span className=' text-2xl text-gray-200 font-bold'>Fragrance And Residue</span>
            </span>
            <span>
          ...
          <div className='bg-violet-700 w-full p-4  flex flex-col rounded-md shadow-md my-4'>
            <span className='flex flex-row items-center'>
              ...
              <span className=' text-2xl text-gray-200 '>Environment Friendly</span>
            </span>
            <span>
              <p className='text-gray-200 '>With increasing environmental concerns, choosing our cleaning products that are eco-friendly and biodegradable is essential. These products have a lower impact on the environment during manufacturing, usage, and disposal.</p>
            </span>
          </div>
        </div>
      </div>
