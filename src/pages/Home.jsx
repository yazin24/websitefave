    ...
    <div>
      <div class="wrapper flex justify-center items-start">
        <span className="colorlay w-full">
          <section className="flex flex-col items-center justify-center bg-blue-300/10 backdrop-blur-sm drop-shadow-lg shadow-md p-6 rounded-lg mx-8 lg:mx-96 mt-24 md:mt-44">
            <h2 className="text-lg md:text-2xl text-center font-bold mb-4 text-amber-500 front-text">
      ...
      <div className="flex justify-center items-center mx-4 md:mx-44 lg:mx-96 mt-4" data-aos="fade-down"
        ...
        <div className="flex-col bg-violet-700 p-4 md:p-8 rounded-md mt-10 md:mt-36 shadow-md">
          ...
          <p className="text-gray-200 font-bold text-center mt-2">
        ...
        <div className="flex flex-col md:flex-row justify-center w-full mb-4">
          ...
          <div className="p-4 w-full md:w-1/3" data-aos="fade-right"
            ...
            <div className="bg-violet-700 p-4 rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <FaCheckCircle className="text-2xl text-gray-100 mr-1" />
                </span>
          ...
          <div className="p-4 w-full md:w-1/3" data-aos="zoom-in"
            ...
            <div className="bg-violet-700 p-4 rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <FaExchangeAlt className="text-2xl text-gray-100 mr-1" />
                </span>
          ...
          <div className="p-4 w-full md:w-1/3" data-aos="fade-left"
            ...
            <div className="bg-violet-700 p-4 rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <FaMagic className="text-2xl text-gray-100 mr-1" />
                </span>
                <span className=" text-lg text-gray-200 font-bold">
                  Effectiveness
                </span>
        ...
        <div className="flex flex-col md:flex-row justify-center w-full mb-4">
          ...
          >
            <div className="bg-violet-700 p-4 rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <FaHandsWash className="text-2xl text-gray-100 mr-1" />
                </span>
                <span className=" text-lg text-gray-200 font-bold">
                  Ease Of Use
                </span>
          ...
          <div className="p-4 w-full md:w-1/3" data-aos="zoom-in"
            ...
            <div className="bg-violet-700 p-4 rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <GiFragrance className="text-2xl text-gray-100 mr-1" />
                </span>
                <span className=" text-lg text-gray-200 font-bold">
          ...
          <div className="p-4 w-full md:w-1/3" data-aos="fade-left"
            ...
            <div className="bg-violet-700 p-4 flex flex-col rounded-md shadow-md my-4">
              <span className="flex flex-row items-center">
                <span>
                  <FaTree className="text-2xl text-gray-100 mr-1" />
                </span>
                <span className=" text-lg text-gray-200 font-bold">
