      ...
      <div className="bg-gradient-to-l from-violet-900 via-violet-400 to-blue-100 py-4 md:px-10 px-7 md:flex items-center justify-between">
        <div className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-gray-800">
          <span className="text-3xl text-indigo-600 mr-1 pt-1">
            <a href="/">
              <img className="h-12 w-22 ml-10" src="/newlogo.png" alt="Logo" />
            </a>
          </span>
        </div>
        ...
        >
          {Links.map((Link) => (
            <li
              key={Link.name}
              className="text-md md:my-0  my-2 pt-4 mr-12"
            >
              <a
                href={Link.link}
                className="text-yellow-600 md:text-gray-200 font-bold hover:bg-yellow-500 md:p-6 md:pt-10 duration-200"
              >
                {Link.name}
              </a>
            </li>
