...
const Reviews = () => {
  ...
  <p class="mb-6 pb-2 md:mb-12 md:pb-0">
    Customer satisfaction is one of our mission.
    Take a look at our customer reviews to us for your references.
  </p>
</div>
...
<div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
  ...
  <div class="mb-12 md:mb-0">
    ...
    Bilis ng delivery. Active na active si seller. 2nd time order. At meron pa susunod baka bukas na naman delivery. Kaya 5 Star

sinubukan ko agad, dalawang extreme bula ba naman ayun super bula."
  ...
  <div class="mb-12 md:mb-0">
    ...
    <p class="mb-4">
    "It's easy to mix. Need mo lang talaga mag adjust sa tubig at thickener para okay ang output. May additional degreaser yung first na mixture kasi medyo watery sya. Hands po gamit ni hubby para sure daw na mahalo. 😂 Budget wise. Thank you seller!"
    </p>
    <ul class="mb-0 flex items-center justify-center">
      <li>
        <svg
  ...
  <div class="mb-0">
    ...
    <div class="mb-12 md:mb-0">
    <h5 class="mb-4 text-xl font-semibold">Ben Campbell</h5>
