...
import faveVideo from "./public/faveVideo.mp4";
...
const Videoplayer = () => {
  return (
    <div className="md:py-24 py-10 colorlay px-2">
      <h2 class=" flex justify-center text-center text-md md:text-2xl font-semibold text-amber-500">Introducing Our Dishwashing Liquid</h2>
    <p class="text-amber-600 flex justify-center text-center mb-8">Experience the cleaning power like never before!</p>
